...
- **FR-021**: O sistema MUST sincronizar os **fornecedores** e permitir que o escritório os **cadastre e edite** pela nuvem (deduplicação pelo **nome normalizado**, com documento como desempate), de modo que um recebimento possa ser vinculado a fornecedor novo mesmo com o notebook desligado.

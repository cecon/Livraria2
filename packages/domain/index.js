 ...
 * @param {number} soma_movimentos
 * @returns {number}
 */
export function baseline_saldo_inicial(estoque_atual, soma_movimentos) {
    const ret = wasm.baseline_saldo_inicial(estoque_atual, soma_movimentos);
    return ret;
}
 ...
 * @returns {number}
 */
export function clamp_baixa_venda(qtd, saldo) {
    const ret = wasm.clamp_baixa_venda(qtd, saldo);
    return ret;
}
 ...
 * @param {number} qtd
 * @param {number} custo_unit_centavos
 * @returns {number}
 */
export function custo_medio_apos_entrada(estoque_atual, medio_centavos, qtd, custo_unit_centavos) {
    const ret = wasm.custo_medio_apos_entrada(estoque_atual, medio_centavos, qtd, custo_unit_centavos);
    return ret;
}

/**
 * Diferença de contagem de inventário: `contado − sistema`.
 * @param {number} sistema
 * @param {number} contado
 * @returns {number}
 */
export function diferenca_contagem(sistema, contado) {
    const ret = wasm.diferenca_contagem(sistema, contado);
    return ret;
}
 ...
 * @param {any} movimentos
 * @returns {any}
 */
export function recompor_ledger(movimentos) {
    const ret = wasm.recompor_ledger(movimentos);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function to_brl(centavos) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.to_brl(centavos);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];

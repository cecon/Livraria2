  ...
  async rewrites() {
    return {
      beforeFiles: [
        ...
        { source: "/api/pdv/renovar", destination: `${nuvemApiUrl}/api/v1/auth/pdv/renovar` },
        { source: "/api/pdv/catalogo", destination: `${nuvemApiUrl}/api/v1/sync/catalogo` },
        { source: "/api/pdv/catalogo/confirmacao", destination: `${nuvemApiUrl}/api/v1/sync/catalogo/confirmacao` },
        { source: "/api/pdv/vendas", destination: `${nuvemApiUrl}/api/v1/sync/vendas` },
        { source: "/api/pdv/vendas/:uid/cancelamento", destination: `${nuvemApiUrl}/api/v1/sync/vendas/:uid/cancelamento` },
        { source: "/api/pdv/turnos", destination: `${nuvemApiUrl}/api/v1/sync/turnos` },
        { source: "/api/pdv/turnos/:uid/encerramento", destination: `${nuvemApiUrl}/api/v1/sync/turnos/:uid/encerramento` },
        { source: "/api/pdv/caixa-movimentos", destination: `${nuvemApiUrl}/api/v1/sync/caixa-movimentos` },
        { source: "/api/api/pdv/renovar", destination: `${nuvemApiUrl}/api/v1/auth/pdv/renovar` },
        { source: "/api/api/pdv/catalogo", destination: `${nuvemApiUrl}/api/v1/sync/catalogo` },
        { source: "/api/api/pdv/catalogo/confirmacao", destination: `${nuvemApiUrl}/api/v1/sync/catalogo/confirmacao` },
        { source: "/api/api/pdv/vendas", destination: `${nuvemApiUrl}/api/v1/sync/vendas` },
        { source: "/api/api/pdv/vendas/:uid/cancelamento", destination: `${nuvemApiUrl}/api/v1/sync/vendas/:uid/cancelamento` },
        { source: "/api/api/pdv/turnos", destination: `${nuvemApiUrl}/api/v1/sync/turnos` },
        { source: "/api/api/pdv/turnos/:uid/encerramento", destination: `${nuvemApiUrl}/api/v1/sync/turnos/:uid/encerramento` },
        { source: "/api/api/pdv/caixa-movimentos", destination: `${nuvemApiUrl}/api/v1/sync/caixa-movimentos` },

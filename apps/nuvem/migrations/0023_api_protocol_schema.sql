-- Consolida o schema de protocolo da API NestJS no migrador principal.
-- Estes scripts continuam idempotentes e precisam existir em qualquer Postgres da nuvem.

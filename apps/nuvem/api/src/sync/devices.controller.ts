...
export class DevicesController {
  ...
  async list(@Req() req: AuthRequest) {
    ...
    return this.db.$queryRaw`
      select d.uid::text, d.nome, d.ativo, d.cursor_aplicado::text as "cursorAplicado",
        d.cursor_entregue::text as "cursorEntregue", d.confirmado_em as "confirmadoEm",
        c.sequencia::text as "cursorDisponivel"
      from public.nuvem_pdv d cross join public.nuvem_sync_contador c order by d.nome limit 1000`;
  }
}

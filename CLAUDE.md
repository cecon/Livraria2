...
`specs/003-fornecedores-lancamento-notas/plan.md`
(base features: `specs/001-sistema-estoque-vendas/plan.md`, `specs/002-estoque-movimentos-inventario/plan.md`)
...
`specs/003-fornecedores-lancamento-notas/spec.md`.
<!-- SPECKIT END -->
